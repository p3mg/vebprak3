...
export default async function RecipePage({ params }) {
    ...
    return (
    <div className="flex flex-col max-w-3xl mx-auto p-6 bg-black rounded shadow">
    <Link href="/" className="text-red-500 hover:underline mb-4">← Go Back</Link>
    ...
    <table className="w-full mt-2 mb-6 table-auto border-collapse border border-gray-300">
        <thead>
            <tr className="bg-white">
                <th className="text-black border border-gray-300 px-4 py2 text-left">Ингредиент</th>
                <th className="text-black border border-gray-300 px-4 py-2 text-left">Количество</th>
            </tr>
    </thead>
    <tbody>
